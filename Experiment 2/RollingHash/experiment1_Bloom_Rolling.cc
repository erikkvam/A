...
int main(int argc, char *argv[]){
    ...
    if(argc == 8){
        //./main [k hashfunctions] [p familyhash] [MOD familyhash] [n iterations] [sizeKey n] [T tableSize] [num proves]
        ...
        //./main [p hash] [MOD hash] [n iterations] [sizeKey n] [T tableSize] [num proves] 
        ...
        //./main [p hash] [MOD hash] [n iterations] [sizeKey n] [T tableSize]
        pFamily = charToInt(argv[1]);
        mFamily = charToInt(argv[2]);
        nKeys = charToInt(argv[3]);
        maxN = charToInt(argv[4]);
    ...
    for(int k = 0; k < num_proves; ++k){
        Bloom_Filter_Rolling bloom(sizeT);
